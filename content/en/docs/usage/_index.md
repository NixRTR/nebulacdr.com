...
- **[ncclient](/docs/usage/ncclient/)** – Preferred method: device client for installation and usage (Docker, CLI, Windows Tray, NixOS). Enroll once, then ncclient polls for config and certs and can run Nebula.
