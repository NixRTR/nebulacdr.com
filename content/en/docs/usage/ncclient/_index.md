...
- **[Installation](/docs/usage/ncclient/installation/)** – Docker (preferred for first lighthouse), binaries (Web UI or GitHub Releases), Windows Installer (MSI), NixOS module, or Pip (PyPI) as fallback.
